...
Client.prototype.subscribe = function() {
  this._websocket = new WebSocket('wss://' + this._podhost);
...
Client.prototype.registerIdentity = function(callback) {
  ...
  this._identity.sign(self._pubkey, function(err, message) {
    if (err) {
      return callback(err);
    }
...
Client.prototype.sendMessageKey = function(userID, key, callback) {
  ...
  var url = 'https://' + podhost + '/chats';
  var data = { key: key, to: userID, from: this._identity.userID };
...
* @param {function} callback
*/
Client.prototype.getMissedMessages = function(token, callback) {
  var url = this._baseUrl + '/chats';
...
* @param {function} callback
*/
Client.prototype.purgeMessageHistory = function(token, callback) {
  var url = this._baseUrl + '/chats';
  var query = { token: token };
