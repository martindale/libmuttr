...
*/
function Client(identity, options) {
  if (!(this instanceof Client)) {
    return new Client(identity, options);
  }
  ...
  this._request = request.defaults(this.options.requestOptions);
}
...
Client.prototype.registerIdentity = function(callback) {
  ...
  this._request.post(options, this._handleResponse(callback));
};
...
Client.prototype.getPublicKeyForUserID = function(userID, callback) {
  ...
  this._request.get(href, this._handleResponse(callback, { json: false }));
};
...
Client.prototype.requestFindMessage = function(key, callback) {
  ...
  this._request.get(url, this._handleResponse(callback, { json: false }));
};
...
Client.prototype.getInboxes = function(token, callback) {
  ...
  this._request.get({ url: url, qs: query }, this._handleResponse(callback));
};
...
Client.prototype.purgeInboxes = function(token, callback) {
  ...
  this._request.del({ url: url, qs: query }, this._handleResponse(callback));
};
